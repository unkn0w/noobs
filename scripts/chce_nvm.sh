...
echo "> Aby zacząć korzystać, wykonaj jedną z poniższych czynności:"
echo "  a) uruchom ponownie sesję (wyloguj i zaloguj),"
echo "  b) uruchom ponownie powłokę (exec "\$SHELL"),"
echo "  c) ręcznie załaduj NVM (source $NVM_DIR/nvm.sh)."
echo "  NVM będzie się ładował automatycznie."
